...
`extensions/org.shilpo.wallpaper`, `extensions/org.shilpo.weather`, and `extensions/io.github.alice.world-clock`, plus the TypeScript showcase in `extensions/org.shilpo.example/`.
